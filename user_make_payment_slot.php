...
extract($_POST);
 ...
 $q="SELECT * FROM  `bookings` inner join slots using (slot_id)    WHERE `slot_id`='$book' AND `from_time`='$from_time' and `to_time`='$to_time' and day='$day'";
    $res=select($q);
    if (sizeof($res)>0)
    {
...
$qin="INSERT INTO `payments` VALUES(NULL,'$book','turf','online',NOW(),'$amount')";
insert($qin);
$q2="INSERT INTO `bookings` VALUES(NULL,'$u_id','$book',now(),'paid')";
insert($q2);
...
$mail->Port = 587;
$mail->Username = "playhub951@gmail.com"; 
$mail->Password = "gqbkztnqroeedham";


$mail->From = "Play Hub";
$mail->FromName = "playhub951@gmail.com"; 
$mail->AddAddress($email);
$mail->Subject ="Slot Booking ";
$mail->Body    = str_replace("<br />", "\n", nl2br("Your Slot Booked Succesfully ")) ;
$mail->AltBody = "";
...
// $mail->Port = 587;
// $mail->Username = "playhub951@gmail.com"; 
// $mail->Password = "playhub123";


// $mail->From = "Councillor App Account";
// $mail->FromName = "playhub951@gmail.com"; 
// $mail->AddAddress("riss.mamtha@gmail.com");                  
// $mail->Subject ="Schedule successfully";
// $mail->Body    = str_replace("<br />", "\n", nl2br("Scheduling Details \r Date : $dt \r Starting Time : $st \r Ending Time : $et ")) ;
// $mail->AltBody = "";
    ...
    <div class="payment">
      ...
      <form class="form" method="post">
        ...
        <div class="form__name form__detail">
          ...
          <input type="text" placeholder="Enter yout Name" required name='name' id="name" maxlength="24">
        ...
        <div class="form__number form__detail">
          ...
          <input type="text" placeholder="0000 0000 0000 0000" id="number" required name=number onkeypress="return isNumeric(event)">
        ...
        <div class="form__expiry form__detail">
          ...
          <input type="text" placeholder="MM/YY" id="date" required name="exry" onkeypress="return isNumeric(event)" >
        ...
        <div class="form__cvv form__detail">btn
          <label for="cvv">CVV
            <ion-icon name="information-circle" class="info"></ion-icon></label>
          <ion-icon name="lock-closed-outline"></ion-icon>
          <input type="password" placeholder="0000" id="cvv" maxlength="3" onkeypress="return isNumeric(event)" >
        ...
        <button type="submit" name="btn" class="form__btn">Confirm</button>
