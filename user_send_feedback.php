...
<div class="container">
    ...
    <div class="form-container">
        <form method="post">
            ...
            <p class="center-text">Thank you for Using <strong>Turf <?php echo $tname ?>.</strong> We would like to know how we performed. Please spare some moments to give us your valuable feedback as it will help us in improving our service.</p>
